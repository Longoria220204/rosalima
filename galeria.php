...
<body>
    ...
    <?php include_once './views/web/partials/header.php'; ?>

    <section id="portada">
        <img src="./public/img/web/portada-inicial.png" width="100%" alt="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 px-5 d-flex justify-content-center" style="position:relative;">
                    ...
                    <div class=" py-2 pt-5">
                        <h5>Reconociendo la importancia de contextualizar el proceso de enseñanza-aprendizaje en el nivel inicial, y en el marco del Currículo Nacional de la Educación Básica, nuestra propuesta busca diversificar los desempeños en las cuatro áreas principales del plan de estudios, integrándolos dentro del plan anual y las unidades didácticas (aprendizajes, proyectos y módulos).</h5>
                        <br>
                        <h5>De manera específica, implementaremos las siguientes estrategias:</p>
                        </h5>
                ...
                <div class="col-lg-6 col-md-2 py-5" id="info">
