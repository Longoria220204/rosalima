                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tf__breadcrumb_text">
                            <h1>Pastoral Educativa</h1>
                            <div class="page_breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="./">Inicio</a></li>
                                        <li class="breadcrumb-item" style="color:var(--color4);font-weight:700;">Pastoral</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 px-5">
                    <!-- <h2>Bienvenidos</h2>
                    <br> -->
                    <p>La Pastoral Educativa es el eje evangelizador de nuestra Institución Educativa, orientado a la formación integral de los estudiantes, docentes, familias y personal administrativo, bajo la inspiración del carisma dominico. Enraizada en los valores del Evangelio y en la tradición de Santo Domingo de Guzmán, busca generar espacios de encuentro con Cristo, fomentando la búsqueda de la verdad, el compromiso con la justicia y la fraternidad.</p>
                    <p>La Pastoral Educativa no es solo un área específica, sino una dimensión transversal que impregna todas las actividades escolares. Se expresa en la enseñanza, en la vida cotidiana de la Institución Educativa y en el testimonio de quienes forman parte de la comunidad educativa.</p>
                    <!--  <br>
                    <div class="mt-lg-5">
