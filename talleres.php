                            ...
                            <div class="page_breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item" style="color:var(--color4);font-weight:700;">Talleres</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 px-5">
                    <p>En 1972, la profesora Miriam Zegarra Alcázar y su esposo, el profesor Guillermo Tapia Zegarra, fundaron el Colegio Jean Piaget en el distrito de Carabayllo, cuando aún predominaban las tierras de cultivo. Observando la necesidad de una educación privada con visión de futuro, crearon en 1974 el Centro de Educación Inicial "Jean Piaget". A los pocos años, debido a la creciente demanda, se ampliaron los niveles de primaria y secundaria.</p>
                    <p>Desde entonces, el colegio ha mantenido su compromiso con la innovación educativa, formando más de 40 promociones de estudiantes destacados. El éxito de Jean Piaget se debe a su enfoque pedagógico, el compromiso de su personal y estudiantes, y su constante adaptación a las demandas de la sociedad. La institución ha ganado diversos premios en matemáticas, ciencias y música a nivel local, nacional e internacional, y ha visto a sus estudiantes ingresar a las mejores universidades sin necesidad de preparación preuniversitaria adicional.</p>
                    <p>En 2024, se implementó el taller de futsal en varias categorías, mientras que en el área de Educación Religiosa se fortalece la formación ética y en valores. Desde 2022, el colegio es un centro preparador de certificaciones Cambridge, y mantiene alianzas con diversas universidades. Hoy, el Colegio Jean Piaget es una institución que promueve una educación integral, donde sus estudiantes destacan no solo por sus conocimientos, sino por sus valores, habilidades comunicativas, dominio del inglés y tecnología, liderazgo y aptitudes musicales.</p>
                    <p>Tras 49 años, el Colegio Jean Piaget continúa transformándose para formar estudiantes capaces de enfrentar los retos del futuro.</p>

                </div>
                <div class="col-lg-6 px-5 d-flex justify-content-center" style="position:relative;">
                    <div style="z-index:99;">
                        <center><video src="./public/video/ingles_inicial.mp4" controls autoplay width="70%" muted style="box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.4); border-radius: 8px;"></video></center>
                    </div>
                    <img width="80" style="position:absolute;top:-6%;right:15%;z-index:1; animation: banner_animi_2 2s linear infinite alternate;" src="./public/img/icons/miselanea1.png" alt="">
                        ...
                        <a href="view2?id=2">
                            <div class="card shadow" style="border-radius:5px;">
                                ...
                                <div class="cardbody1 mx-3 py-3">
                                    ...
                                    <div class="detalle">
                                        <p>En el Colegio Jean Piaget, nuestro Taller Instrumental es el espacio perfecto para que nuestros estudiantes desarrollen su talento musical, aprendan a interpretar diferentes instrumentos y descubran la magia de la música.
                                        </p>
                                    </div>
